...
project = u'Astropy'
copyright = u'2012, The Astropy Collaboration. Logo designed by Kyle Barbary'
...
latex_documents = [
  ('index', 'Astropy.tex', u'Astropy Documentation',
   u'The Astropy Collaboration', 'manual'),
]
...
texinfo_documents = [
  ('index', 'Astropy', u'Astropy Documentation',
   u'The Astropy Collaboration', 'Astropy', 'One line description of project.',
   'Miscellaneous'),
]
